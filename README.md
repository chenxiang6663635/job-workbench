...
- **Interface typography**: four interface-size steps shown as real percentages (87.5% / 100% / 112.5% / 125% — root-font scaling, decoupled from desktop zoom and available in a plain browser), plus a serif option (Times / Songti) alongside Inter and system fonts.
