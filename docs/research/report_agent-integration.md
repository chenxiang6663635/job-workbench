...
1. **dsh 插件比早期评估便宜得多**：最小 JS 外壳 **15–40 行**；甚至可以「零 JS 的技能包」或「<10 行的挂载插件 + SKILL.md」。业务逻辑可以完整留在 Python。
...
- **截至调研日（2026-09-10）**：本仓 `install_skills.py` 只做「复制到 N 个目标」，**缺「校验」与「名称冲突检查」两段**。
