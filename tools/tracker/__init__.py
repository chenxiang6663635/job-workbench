...
_HOME = ("_core", "_schema", "_check", "applications", "interviews", "talks",
         ...
         "preview_update", "_cli", "_cli_interview", "_cli_talk", "_cli_mail",
         "_cli_contact", "_cli_offer", "_cli_misc")
