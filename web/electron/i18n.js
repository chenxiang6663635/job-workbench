...
const TABLES = {
  en: {
    ...
    backendDiedDetail: "Please restart the app; if it keeps happening, send the [backend-err] lines from the app log. If restarts keep failing, see docs/usage-guide (FAQ).",
  ...
  "zh-CN": {
    ...
    backendDiedDetail: "请重启应用；若反复出现，请把应用日志里的 [backend-err] 段落一起反馈。重启仍失败时看 docs/usage-guide 的「常见问题」章。",
