...
const zhCN = {
  ...
  "records.deleteHint": "预览将删除的整行；确认后落盘，删前快照留在工作区之外（可整份拷回对应 CSV）。",
  "records.deleteConfirm": "确认删除",
  "records.deleting": "正在删除…",
  "records.previewing": "正在生成删除预览…",
  "bank.writing": "写入中…",
  "bank.noChange": "还没有改动",
  ...
  "drill.mode": "模式",
  "drill.mode.due": "重练队列",
  "drill.mode.wrong": "只错题",
  "drill.mode.random": "随机",
  "drill.size": "一轮题数",
  "drill.keyword": "关键词（可选）",
  "drill.start": "抽题",
  "drill.starting": "抽题中…",
  "drill.empty": "还没有抽题",
  ...
  "app.jobLink": "岗位链接",
  "app.viewCard": "查看解析卡",
  "app.created": "已创建投递：{{company}} {{role}}",
  "app.importedCount": "已导入 {{count}} 条投递",
  "app.openLink": "打开岗位链接",
  ...
  "job.newJob": "新建岗位",
  "job.searchPlaceholder": "搜索公司 / 岗位",
  "job.created": "已新建岗位：{{company}} {{role}}",
  "job.asc": "升序",
  "job.desc": "降序",
  ...
  // 服务商预设与授权码引导（邮箱配置批）：**表在后端**（jobws_core/mail_providers.py），
  // 这里只放语言——两张表必然漂移，只有后端那一处说了算。
  "settings.imapProvider": "服务商",
  "settings.imapProviderManual": "其它（手工填写）",
  "settings.imapProviderAuto": "已识别：{{name}}",
  "settings.imapProviderApply": "套用",
  "settings.imapAuthHintTitle": "怎么拿授权码",
  "settings.imapOpenGuide": "打开官方指引",
  "settings.imapFolderLoad": "读取可用文件夹",
  "settings.imapFolderLoading": "读取中…",
  "settings.imapFolderCandidates": "可用文件夹（点一下填入）",
  "mailProvider.qq": "QQ 邮箱 / Foxmail",
  "mailProvider.netease163": "网易 163 邮箱",
  "mailProvider.netease126": "网易 126 邮箱",
  "mailProvider.yeah": "网易 yeah.net",
  "mailProvider.gmail": "Gmail",
  "mailProvider.outlook": "Outlook / Hotmail",
  "mailProvider.aliyun": "阿里云邮箱",
  "mailProvider.sina": "新浪邮箱",
  "mailProvider.sohu": "搜狐邮箱",
  "mailProvider.hintQq": "QQ 邮箱不接受网页登录密码：在网页版「设置 → 账户」开启 IMAP/SMTP 服务，按提示验证后拿到 16 位授权码，填到上面那一栏。",
  "mailProvider.hintNetease": "网易邮箱要两步：① 在网页版开启「客户端授权密码」并设置授权码（关掉授权码会连 IMAP 一起关，之后报的还可能是「密码错误」）；② 客户端须先声明身份——本工作台登录后会自动发 IMAP ID，你不用管。",
  "mailProvider.hintGmail": "Gmail 要「应用专用密码」：先在 Google 账户开启两步验证，再生成 16 位应用专用密码——网页登录密码一定失败。",
  "mailProvider.hintOutlook": "Outlook 个人账号已停用基本认证，需要 OAuth2——本工作台暂不支持。",
  "mailProvider.hintGeneric": "多数邮箱要先在网页版单独开启 IMAP，并生成「授权码 / 应用专用密码」——网页登录密码通常不行。",
  ...
  "settings.groupServices": "外部服务",
  "settings.groupData": "数据与关于",
  "settings.toolsSearchPlaceholder": "搜索设置项（试试 @modified 只看改过的）",
  "settings.toolsSearchLabel": "搜索设置项",
  "settings.toolsModifiedOnly": "只看已修改",
  "settings.toolsGroups": "设置分组",
  "settings.toolsAll": "全部分组",
  "settings.toolsNoMatch": "没有匹配的设置——换个关键词，或点「全部分组」回到全部。",
  "settings.effectInstant": "即时生效",
  "settings.effectSave": "保存后生效",
  "settings.effectRestart": "重启后生效",
  "settings.statusTitle": "外观与偏好",
  "settings.statusDesc": "这几项存在本机（浏览器存储 / 桌面端偏好），不随工作区导出或备份——所以这里列出当前值、生效方式，以及怎么退回默认。",
  "settings.statusModified": "已改",
  "settings.statusResetOne": "还原默认",
  "settings.statusResetAll": "全部还原默认（{{n}} 项）",
  "settings.entryTheme": "主题",
  "settings.entryFont": "界面字体",
  "settings.entryMono": "等宽字体",
  "settings.entryNumeric": "数字字体",
  ...
  "settings.reminderDays_5": "提前 5 天",
  "settings.reminderDays_7": "提前 7 天",
  ...
  "imap.refetch": "重新拉取",
  // 邮件解析建议（批 9）：卡片逐条确认，写入走既有链路
  "suggest.title": "解析建议",
  "suggest.loading": "正在解析正文与日历...",
  "suggest.empty": "没有解析出可写入的线索",
  "suggest.kindTime": "时间",
  "suggest.kindDeadline": "截止事项",
  "suggest.kindLinkExpiry": "链接有效期",
  "suggest.kindLink": "会议链接",
  "suggest.kindStage": "建议阶段",
  "suggest.kindRecord": "对应岗位",
  "suggest.high": "高把握",
  "suggest.low": "需核对",
  "suggest.confirm": "确认写入",
  "suggest.ignore": "忽略",
  "suggest.done": "已写入",
  ...
  "suggest.copy": "复制链接",
  "suggest.copied": "已复制",
  "suggest.openFull": "打开完整解析对话框",
  "suggest.aiTitle": "AI 增强（可选）",
  "suggest.aiRun": "AI 增强",
  "suggest.aiModelLabel": "模型名",
  "suggest.aiModelPlaceholder": "deepseek-chat",
  "suggest.aiFrom": "AI 建议来自 {{model}}",
  "suggest.aiHint": "只产建议：需你核对后才会写入",
  "suggest.aiBadge": "AI",
  "suggest.aiNeedModel": "请先填写模型名（如 deepseek-chat）",
  ...
  "err.imap.rangeInvalid": "`{{field}}` 超出允许范围（上限 {{max}}）——请填一个更小的值",
  ...
  "err.app.deleteFailed": "无法删除投递记录：{{reason}}",
  ...
  "err.prep.missingLines": "缺少行号（需要被点勾选框所在行在 Markdown 源码里的行号，从 1 起）",
  "err.prep.invalidLines": "行号看不懂：{{lines}}（用逗号分隔的行号，如 3,7,9）",
  "err.prep.duplicateLine": "第 {{line}} 行出现了两次（同一行不要重复提交）",
  "err.prep.tooManyLines": "一次最多翻转 {{limit}} 行（这次给了 {{count}} 行）",
  ...
  // base_url 的非阻断提示：key 由后端 base_url_hint() 返回（只报确证过的两种写法）
  "provider.hintDashscope": "通义千问要用兼容模式地址：base_url 请填 https://dashscope.aliyuncs.com/compatible-mode/v1",
  "provider.hintEndpointNotBase": "base_url 只填到版本段（如 …/v1），不要带 /chat/completions",
  "provider.hintNeedScheme": "base_url 要以 http:// 或 https:// 开头",
  // 服务商预设（模型服务批）：地址模板是"起点"不是承诺——保存后「测试连接」才是判据
  "providerPreset.deepseek": "DeepSeek",
  "providerPreset.zhipu": "智谱 GLM",
  "providerPreset.dashscope": "通义千问（阿里云百炼）",
  "providerPreset.kimi": "Kimi（月之暗面）",
  "providerPreset.siliconflow": "硅基流动",
  "providerPreset.openai": "OpenAI",
  "providerPreset.custom": "自定义（兼容 OpenAI）",
  "providerPreset.customNote": "任何 OpenAI 兼容端点：地址填到版本段（如 …/v1），模型名手填",
  "settings.providerPreset": "服务商预设",
  "settings.providerModel": "默认模型",
  "settings.providerModelHint": "留空则三处 AI 功能都要求手填模型名",
  "settings.providerModelsTitle": "可用模型（点一下填入）",
  "settings.providerModelsEmpty": "没拉到模型列表——这不代表不能用：有些服务没实现 /models，直接手填模型名即可。",
  "settings.providerModelsTruncated": "只显示前 {{shown}} 个（共 {{total}} 个）",
  // 两张卡的按钮都叫「测试」，读屏与自动化都需要知道测的是哪一张
  "settings.imapTestAction": "测试邮箱连接",
  "settings.providerTestAction": "测试模型服务连接",
  ...
  // 登录失败的细分（会话层给 code，路由层原样透出）：两类的下一步完全不同，
  // 合成一句"登录失败"等于把可操作指引磨掉
  "err.imap.unsafeLogin": "邮箱要求客户端先声明身份，但这一步没通过：{{error}}——多半是网页版还没开启 IMAP 服务，或授权码已失效 / 被关闭（163 / 126 / yeah.net 请到网页版重新生成客户端授权码）",
  "err.imap.authFailed": "登录被拒：{{error}}——请确认填的是「授权码 / 应用专用密码」而不是网页登录密码；若确认无误，可能该邮箱已关闭 IMAP，或这条授权码被停用了",
  ...
  "err.progress.mailDeleteFailed": "无法删除邮件：{{reason}}",
  "err.progress.interviewDeleteFailed": "无法删除面试记录：{{reason}}",
  "err.progress.contactDeleteFailed": "无法删除联系人：{{reason}}",
  "err.progress.talkDeleteFailed": "无法删除宣讲会：{{reason}}",
  "err.progress.offerDeleteFailed": "无法删除 Offer：{{reason}}",
  ...
  "mail.bodyOriginalNote": "保留引用与签名，与收到的邮件一致",
  "mail.bodyExcerpt": "摘录",
  "mail.bodyExcerptNote": "已去掉引用与签名，仅用于解析",
  "mail.bodyTruncated": "已截断（全文 {{n}} 字）",
